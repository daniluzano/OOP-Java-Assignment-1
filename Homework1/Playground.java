...
public class Playground {
    ...
    public Playground (String pathName) {
        try {
            final Image imageTree = ImageIO.read(new File("Homework1/resources/img/tree.png"));
            final Image imageGrass = ImageIO.read(new File("Homework1/resources/img/grass.png"));
            final Image imageRock = ImageIO.read(new File("Homework1/resources/img/rock.png"));
            final Image imageTrap = ImageIO.read(new File("Homework1/resources/img/trap.png"));
